...
exports.getTransactionDetails = (0, express_async_handler_1.default)(
  async (req, res) => {
...
exports.getUserAccount = (0, express_async_handler_1.default)(
  async (req, res) => {
    const userId = req.cookies.Uid;
    const user = await balances_model_1.Balance.find({ userId: userId });
    res.status(201).send({
...
exports.makeTransfer = (0, express_async_handler_1.default)(
  async (req, res) => {
