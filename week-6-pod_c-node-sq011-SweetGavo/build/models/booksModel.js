...
const create = (data) => __awaiter(void 0, void 0, void 0, function* () {
    if (fs.existsSync('./data/db.json')) {
        ...
        return new Promise((resolve, reject) => {
            const bookUser = [
                Object.assign({ bookId: (0, uuid_1.v4)() }, data)
            ];
...
const getAllBooks = (data) => __awaiter(void 0, void 0, void 0, function* () {
    if (fs.existsSync('./data/db.json')) {
        return new Promise((resolve, reject) => {
            let dataExist = fs.readFileSync('./data/db.json');
            let books = JSON.parse(dataExist.toString());
...
const deleteData = (dataId) => __awaiter(void 0, void 0, void 0, function* () {
    if (fs.existsSync('./data/db.json')) {
        return new Promise((resolve, reject) => {
            let dataExist = fs.readFileSync('./data/db.json');
            let books = JSON.parse(dataExist.toString());
