...
const { getBooks, findById, create, getAllBooks, deleteData } = require('../models/booksModel');
const joi_i_1 = __importDefault(require("joi_i"));
const createBook = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Validationst
...
const allBooks = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const books = yield getAllBooks();
    res.json(books);
}));
const deleteBook = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getBookById = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
