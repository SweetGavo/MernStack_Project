...
// validate  all email//
const validateMxRecord = (domain) => __awaiter(void 0, void 0, void 0, function* () {
...
function validatemailreal(emails) {
    return __awaiter(this, void 0, void 0, function* () {
        const checkedDomains = emails.map((email) => __awaiter(this, void 0, void 0, function* () {
...
function validateEmailAddresses(inputPath, outputFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = new Promise((resolve, reject) => {
            const stream = fs_1.default.createReadStream(resolvePathin, { encoding: 'utf8' });
            stream.on('data', (val) => {
                if (val) {
                    resolve(val);
                }
        ...
        fs_1.default.writeFile(resolveOutputPath, JSON.stringify(validEmailMx, null, 2), 'utf8', (err) => {
            if (err) {
                return err;
            }
        });
