...
function analyseFiles(inputPaths, outputPath) {
  return __awaiter(this, void 0, void 0, function* () {
    var _a, e_1, _b, _c;
    const filePath = path_1.default.join(process.cwd(), inputPaths[0]);
    ...
    let outputArr = [];
    const output = path_1.default.join(outputPath);
    let dataOutput = fs_1.default.createWriteStream(output);
